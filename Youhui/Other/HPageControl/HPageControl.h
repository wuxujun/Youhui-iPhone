...
typedef NS_ENUM(NSUInteger, HPageControlAlignment) {
	HPageControlAlignmentLeft = 1,
	HPageControlAlignmentCenter,
	HPageControlAlignmentRight
};

typedef NS_ENUM(NSUInteger, HPageControlVerticalAlignment) {
	HPageControlVerticalAlignmentTop = 1,
	HPageControlVerticalAlignmentMiddle,
	HPageControlVerticalAlignmentBottom
};
...
@property (nonatomic) HPageControlAlignment alignment					UI_APPEARANCE_SELECTOR; // deafult is Center
@property (nonatomic) HPageControlVerticalAlignment verticalAlignment	UI_APPEARANCE_SELECTOR;	// deafult is Middle
