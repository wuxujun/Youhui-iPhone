...
{
    [self bootstrapStyle];
    self.backgroundColor = [UIColor colorWithRed:65/255.0 green:65/255.0 blue:75/255.0 alpha:1];
    self.layer.borderColor = [[UIColor colorWithRed:65/255.0 green:65/255.0 blue:75/255.0 alpha:1] CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:150/255.0 green:150/255.0 blue:150/255.0 alpha:1]] forState:UIControlStateHighlighted];
