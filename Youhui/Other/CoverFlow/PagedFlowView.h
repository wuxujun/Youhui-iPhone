...
typedef enum {
    PagedDirectionPrevious = 0,
    PagedDirectionDown
} PagedDirectionE;

@interface PagedFlowView : UIView<UIScrollViewDelegate>{
    
    PagedFlowViewOrientation _orientation;//默认为横向
    
    UIScrollView        *_scrollView;
    UIImageView         *_defaultImageView;
    
    UIImageView         *_boxblurImageView;
...
-(void)didReloadBlurData:(UIImageView*)cell cellForPageAtIndex:(NSInteger)index;
