...
#import "HPagesContainer.h"
#import "HPagesContainerTopBar.h"
#import "HPageIndicatorView.h"


@interface HPagesContainer () <HPagesContainerTopBarDelegate, UIScrollViewDelegate>

@property (strong, nonatomic) HPagesContainerTopBar *topBar;
...
@implementation HPagesContainer
...
- (void)viewDidLoad
{
    ...
    self.topBar = [[HPagesContainerTopBar alloc] initWithFrame:CGRectMake(0.,
                                                                           0.,
                                                                           CGRectGetWidth(self.view.frame),
                                                                           self.topBarHeight)];
...
{
    if ([self.pageIndicatorView isKindOfClass:[HPageIndicatorView class]]) {
...
- (void)setTopBarBackgroundColor:(UIColor *)topBarBackgroundColor
{
    ...
    if ([self.pageIndicatorView isKindOfClass:[HPageIndicatorView class]]) {
        [(HPageIndicatorView *)self.pageIndicatorView setColor:topBarBackgroundColor];
    }
}
...
- (void)setPageIndicatorImage:(UIImage *)pageIndicatorImage
{
    ...
    if ((pageIndicatorImage && [self.pageIndicatorView isKindOfClass:[HPageIndicatorView class]]) || (!pageIndicatorImage && [self.pageIndicatorView isKindOfClass:[UIImageView class]])) {
    ...
    if (pageIndicatorImage) {
        ...
        [(HPageIndicatorView *)self.pageIndicatorView setColor:self.topBarBackgroundColor];
    }
}
...
- (UIView *)pageIndicatorView
{
    if (!_pageIndicatorView) {
        if (self.pageIndicatorImage) {
            ...
            _pageIndicatorView = [[HPageIndicatorView alloc] initWithFrame:CGRectMake(0.,
                                                                                       44,
                                                                                       self.pageIndicatorViewSize.width,
                                                                                       self.pageIndicatorViewSize.height)];
            [(HPageIndicatorView *)_pageIndicatorView setColor:self.topBarBackgroundColor];
        }
