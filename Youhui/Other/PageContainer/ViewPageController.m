...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.selected) {
        ...
        // Draw the indicator
        [bezierPath moveToPoint:CGPointMake(0.0, CGRectGetHeight(rect) - 0.0)];
        [bezierPath addLineToPoint:CGPointMake(CGRectGetWidth(rect), CGRectGetHeight(rect) - 0.0)];
...
- (UIColor *)tabsViewBackgroundColor {
    ...
    if (!_tabsViewBackgroundColor) {
        UIColor *color = TABLE_BACKGROUND_COLOR;//kTabsViewBackgroundColor;
        if ([self.delegate respondsToSelector:@selector(viewPager:colorForComponent:withDefault:)]) {
...
- (UIColor *)contentViewBackgroundColor {
    ...
    if (!_contentViewBackgroundColor) {
        UIColor *color =TABLE_BACKGROUND_COLOR;// kContentViewBackgroundColor;
        if ([self.delegate respondsToSelector:@selector(viewPager:colorForComponent:withDefault:)]) {
